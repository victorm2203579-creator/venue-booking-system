...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = { ...form }
      if (form.role !== 'student') delete payload.matric_number
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gray-950 flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative">
          <h1 className="text-4xl font-bold text-white leading-tight">
            Join thousands of<br />students & staff.
          </h1>
          <p className="mt-4 text-gray-400 text-base leading-relaxed max-w-sm">
            Create your account and start booking university venues in minutes — no paperwork, no queues.
          </p>
          ...
          <div className="mt-8 p-5 rounded-2xl bg-white/5 border border-white/10">
            ...
            <ul className="space-y-2.5">
              {[
                ...
                'Full booking history & management',
              ].map((item) => (
