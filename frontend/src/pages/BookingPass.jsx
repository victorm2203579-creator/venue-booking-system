...
function getExpiry(booking) {
  ...
  return new Date(end.getTime() + 3 * 60 * 1000)
}
    ...
    <>
      <style>{`
        @media print {
          ...
          #pass { position: fixed; inset: 0; padding: 24px; }
      ...
      <div className="max-w-lg mx-auto space-y-4">
        ...
        >
          ...
          <div className={`flex items-center justify-between px-6 py-3 border-b ${
            isExpired ? 'bg-gray-50 border-gray-100' : 'bg-green-50 border-green-100'
          }`}>
            ...
            <span className={`text-xs font-medium ${
              ...
              {isExpired ? 'This pass has expired' : countdown}
            </span>
          </div>
          ...
          <div className="px-6 py-5 space-y-5">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Attendees</p>
                <p className="text-sm font-semibold text-gray-900">{booking.expected_attendees} people</p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-center py-2">
              <div className={`relative flex flex-col items-center justify-center w-44 h-44 rounded-full border-4 border-dashed ${
                isExpired ? 'border-gray-300 bg-gray-50' : 'border-green-500 bg-green-50'
              }`}>
          ...
          <div className="px-6 py-3 bg-gray-50 border-t border-gray-100">
            <p className="text-[10px] text-gray-400 text-center">
              Official VenueBook Booking Pass · Ref #{shortRef(booking.id)} · Expires 3 minutes after booking ends.
            </p>
          </div>
        </div>
